...
public class CommentRestControllerTest {
    ...
    @Test
    void commentEditTestShouldReturnCorrectCommentDtoOnAdmin() throws Exception {
        // given
    ...
    @Test
    void commentEditTestShouldReturn200OnUser() throws Exception {
        // given
        Comment comment = comments.get(1);
        given(commentService.update(comment)).willReturn(comment);
        // then
    ...
    @Test
    void commentAddTestShouldReturnCorrectCommentDtoOnAdmin() throws Exception {
        // given
    ...
    @Test
    void commentAddTestShouldReturn200OnUser() throws Exception {
        // given
        Comment comment = new Comment(0, books.get(0), "new");
        given(commentService.insert(comment)).willReturn(comment);
        // then
    ...
    @Test
    void commentDeleteTestShouldReturnOkStatusOnAdmin() throws Exception {
        // given
        long commentId = 3L;
    ...
    @Test
    void commentDeleteTestShouldReturn200OnUser() throws Exception {
        // given
        long commentId = 3L;
        doNothing().when(commentService).deleteById(commentId);
        // then
