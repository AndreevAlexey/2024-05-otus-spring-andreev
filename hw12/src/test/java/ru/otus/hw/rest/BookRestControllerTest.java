...
public class BookRestControllerTest {
    ...
    @Test
    void bookAddTestShouldReturn200OnUser() throws Exception {
        // given
        Book newBook = new Book(0, "new", authors.get(1), genres.get(2));
        given(bookService.insert(newBook)).willReturn(newBook);
        // then
    ...
    @Test
    void bookEditTestShouldReturn200OnUser() throws Exception {
        // given
        long bookId = 1L;
        Book book = books.get(0);
        BookDto expected = BookDto.toDto(book);
    ...
    @Test
    void bookDeleteTestShouldReturn200StatusOnUser() throws Exception {
        // given
        long bookId = 3L;
        doNothing().when(bookService).deleteById(bookId);
        // then
