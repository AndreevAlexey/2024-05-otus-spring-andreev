...
public class BookServiceTest {
    ...
    @MockBean
    AclServiceWrapperService aclService;
    ...
    void shouldSaveNewBook() {
        ...
        var genreId = 1L;
        // when
        var returnedBook = bookService.insert(new Book(0, title, new Author(authorId, ""), new Genre(genreId, "")));
        // then
    ...
    void shouldSaveUpdatedBook() {
        ...
        // when
        var returnedBook = bookService.update(expectedBook);
        // then
        assertThat(returnedBook).isNotNull()
                .matches(book -> book.getId() > 0)
                .matches(book -> book.getAuthor().getFullName() != null)
